...
public class DragonFireBallShooterEnchantment extends Enchantment {

    public DragonFireBallShooterEnchantment(Rarity weight, EnchantmentTarget target, EquipmentSlot... slotTypes) {
