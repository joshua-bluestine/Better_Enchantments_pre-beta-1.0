...
public class AstralProjectEnchantment extends Enchantment {

    public AstralProjectEnchantment(Rarity weight, EnchantmentTarget target, EquipmentSlot... slotTypes) {
